...
public class WebdavClientFactory {
    ...
    public static WebdavClient begin(HttpHost host, SSLSocketFactory sslSocketFactory) throws WebdavClientException {
        return Factory.instance().begin(host, null, null, sslSocketFactory);
    }

    /**
     * Pass in a HTTP Auth username/password for being used with all connections
     */
    public static WebdavClient begin(HttpHost host, String username, String password) throws WebdavClientException {
        return Factory.instance().begin(host, username, password);
    }
     ...
     *      href="http://hc.apache.org/httpcomponents-client/httpclient/xref/org/apache/http/conn/ssl/SSLSocketFactory.html">SSLSocketFactory</a>
     */
    public static WebdavClient begin(HttpHost host, String username, String password, SSLSocketFactory sslSocketFactory) throws WebdavClientException {
        return Factory.instance().begin(host, username, password, sslSocketFactory);
    }
    ...
    public static WebdavClient begin(HttpHost host, HttpRoutePlanner routePlanner) throws WebdavClientException {
        return Factory.instance().begin(host, null, null, null, routePlanner);
    }
    ...
    public static WebdavClient begin(HttpHost host, HttpRoutePlanner routePlanner, SSLSocketFactory sslSocketFactory) throws WebdavClientException {
        return Factory.instance().begin(host, null, null, sslSocketFactory, routePlanner);
    }

    /**
     * Useful for when you need to define a http proxy
     */
    public static WebdavClient begin(HttpHost host, String username, String password, HttpRoutePlanner routePlanner) throws WebdavClientException {
        return Factory.instance().begin(host, username, password, null, routePlanner);
    }

    /**
     * Useful for when you need to define a http proxy
     */
    public static WebdavClient begin(HttpHost host, String username, String password, SSLSocketFactory sslSocketFactory, HttpRoutePlanner routePlanner)
